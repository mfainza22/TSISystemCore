...
namespace WeghingSystemCore.Controllers
{
    ...
    [ApiController]
    public class SourceCategoryTargetsController : ControllerBase
    {
        private readonly ISourceCategoryTargetRepository repository;
        private readonly ILogger<SourceCategoryTargetsController> logger;
        public SourceCategoryTargetsController(ILogger<SourceCategoryTargetsController> logger, ISourceCategoryTargetRepository repository)
        {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] SourceCategoryTarget model)
        {
            try
            {
