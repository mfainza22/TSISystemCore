...
namespace WeghingSystemCore.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        private bool validateEntity(Product model)
        {
            ...
            if (!validCode) ModelState.AddModelError(nameof(Product.ProductCode), Constants.Messages.EntityExists("Code"));
            var validName = repository.ValidateName(model);
            if (!validName) ModelState.AddModelError(nameof(Product.ProductDesc), Constants.Messages.EntityExists("Name"));
